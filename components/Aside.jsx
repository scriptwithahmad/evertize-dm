...
const Aside = () => {
  ...
  return (
    <>
      <div className="toggleBtn" title="toggle" onClick={handleToggleAside}>
        <i class="fa-solid fa-arrow-right-arrow-left"></i>
      </div>
      <aside
        className={`asideMain bg-[#010021] relative space-y-8 hover:bg-[#010021fb] max-w-full min-w-[60px] transition-all duration-300`}
        style={{ marginLeft: showAside ? 0 : "-140px" }} 
      >
            ...
            <ul className="asideLinks px-4 text-sm font-medium flex-1">
              ...
              <li>
                ...
                >
                  <i
                    id="sIcon"
                    className="fa-solid fa-gears text-sm text-gray-500"
                  ></i>
                  <div id="links" className="text-blue-200">
                    Services
                  </div>
